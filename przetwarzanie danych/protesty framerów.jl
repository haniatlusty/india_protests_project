...
# ╔═╡ 15d53590-dcf7-11ec-06ba-85c4d7dcdbc4
using StatsKit, Dates

# ╔═╡ 44a496f9-61d0-49e9-a03c-65c5108c9871
using Plots, StatsPlots

# ╔═╡ 1224e465-da3f-4758-8e4e-87d5e3c89295
using VegaLite

# ╔═╡ 47cff682-2e06-402d-a3ef-5aa1be2bd1f0
md"# Prototyp segregacji"

# ╔═╡ 9fffbd2e-889a-4c02-927f-34177849ae53
...
# ╔═╡ 86c09678-6d28-418c-a548-736a32e721bd
...
# ╔═╡ e9b327b4-887e-4a7e-a75f-177f77b10668
df = select(dataset, [:event_date, :year, :event_type, :interaction, :admin1, :notes]);

# ╔═╡ f58104ac-4013-4e04-babc-ffd0a1a6974e
...
# ╔═╡ 9237ee93-29f1-463f-8712-4acfd43604a0
out = refilter(df)

# ╔═╡ a07942af-40dc-452a-80b0-bc87166a56ba
bar(countmap(out.year), title = "Liczba protestów farmerów?")

# ╔═╡ 1e116520-3c33-4d17-93f2-fc04112f6b70
md"## Mapa"

# ╔═╡ 10c44005-b605-4860-b18e-f060eda246ae
...
# ╔═╡ bb369a9d-8d5d-478e-a18b-f6ec8536459b
function statecounter(input::DataFrame)
	counter = countmap(input.admin1)
	d = DataFrame(IDs = getIDs([keys(counter)...]), n = [values(counter)...], state = [keys(counter)...])
end;

# ╔═╡ a446f445-18ca-4458-9516-99dca0a26d17
statedata = statecounter(out);

# ╔═╡ af68fd21-71d9-40b1-9de7-1a40356ff3c3
topo_json = read("../data/mapsindia1.json", String);

# ╔═╡ 300d0497-ee03-464a-b46a-76ec48c88f49
@vlplot(
	height = 700,
	width = 900,
	data = {
