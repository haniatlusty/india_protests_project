...
# ╔═╡ 9db989ca-dc5f-11ec-0af3-1760c4579418
using StatsKit, Dates # statystyka (+CSV i DataFrames) i built-in do obsługi dat

# ╔═╡ 387d76c4-f351-4f88-a0df-88d670aa106a
using VegaLite           # wykresy

# ╔═╡ dd24a415-62c9-467f-9171-e71e752b3818
using PlutoUI            # interaktywne elementy zeszytu

# ╔═╡ 813bf135-0020-4c28-b731-970c23465877
using Statistics

# ╔═╡ 8ecf2d39-212e-4f71-b01a-68cb53cedadb
df = CSV.read(
		"../data/2016-2022.csv", 
...
# ╔═╡ d65dee75-06fc-4d29-b326-7c55d46c53b3
...
# ╔═╡ 61ccbaa1-2d87-46e4-9e90-99c631cd99f1


# ╔═╡ 6651aeab-5d0b-4d7c-ba32-22eb943df723
date_conversion!(df,"month");

# ╔═╡ 8a55eb3d-1e9b-412c-913b-d6fdb424db14
date_conversion!(df,"day_of_week");



# ╔═╡ 82a63483-6422-40f2-bbfd-9b241770806d
date_conversion!(df,"day");

# ╔═╡ 671dc823-d778-465d-aa10-548229f7aa19
function filter_data(data::DataFrame, param::Symbol, value)
	df = subset(data, param => x -> x .== value)
	return df
end

# ╔═╡ 7f1348d0-f159-45a6-893c-2d2b2aea1399
...
# ╔═╡ 94c7c78d-00d7-40a4-b21d-7929436fb676
df_26_01 = by_day(df, 26, "January")

# ╔═╡ 3ee3d3f0-85d6-4826-a322-6a660341cecc
plot = @vlplot(
	:bar,
	data = df_26_01,
	x = :year,
...
# ╔═╡ a9a89764-3965-46ae-86fa-40231ee2b966
df

# ╔═╡ c6612f36-e7dc-4283-bad3-663da94005c3
