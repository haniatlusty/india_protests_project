...
# ╔═╡ c8a3c380-d45f-11ec-1808-4dcf4642c144
using StatsKit, Dates, Plots, FFTW

# ╔═╡ 8cbfa678-eeb8-4cec-a1af-92db136fc323
...
# ╔═╡ 36847868-2e4d-4e71-b6f6-251cea51b584
...
# ╔═╡ f083e9b1-a5fa-4ee4-b99f-181945029f70
ts = timeseries_gen(dataset, "Jammu and Kashmir", (2016,2018), "Riots")

# ╔═╡ 7f714cdf-5dfa-42ee-9224-c00f7616a299
bar(ts.t,ts.n)

# ╔═╡ ebbec0cd-1a13-440d-a97f-601a68c3d072
f = fft(ts.n)

# ╔═╡ fc6e9af5-f7a7-4858-ac66-5f8814676761
plot(2:length(f) ,abs.(f[2:end]))

# ╔═╡ 8a00b924-e915-46f3-93a2-520bccadd039
...
git-tree-sha1 = "69caf1c05c3f9428e8405a15cea80936019355ea"
