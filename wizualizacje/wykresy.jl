...
# ╔═╡ 269ba6f8-1228-4c59-86b7-4cf3201bbe0f
using DataFrames, CSV, VegaLite, StatsKit, Query, Dates

# ╔═╡ 048f0071-12d0-482a-9ba4-cba1ecbe5bb4
using PlutoUI

# ╔═╡ 2e522290-c8c5-11ec-08f1-63012db475d2
df = CSV.read("../data/2016-2022.csv", DataFrame, select = [ "year", "event_date", "event_type", "sub_event_type"])
#df = CSV.read("C:\\Users\\kkarb\\OneDrive\\Pulpit\\projektpm\\data\\2016-2022.csv", DataFrame, select = [ "year", "event_date", "event_type", "sub_event_type"])

# ╔═╡ 12917b6f-90c8-4093-b96e-0f6827b50b34
# z kodu Hani

# ╔═╡ 16be4ab1-a72e-4f02-966c-930dc08f7404
#dates = Dates.Date.(df.event_date, Dates.DateFormat("d U y"))

# ╔═╡ 81253bff-b944-4320-b42b-d2463dc7703e
#months = []

# ╔═╡ 7a803ac2-b75f-4d83-a118-a327297ee3ba
# for date in dates
#     push!(months, Int(Dates.month(date)))
# end

# ╔═╡ 3e6a9e15-9349-4fbc-86bf-769bf8f7fc5b
#df[!,"month"] = months

# ╔═╡ 6eca1758-5b00-4b70-905d-f4370298921a
#wszystkie lata

# ╔═╡ 8db3e3b9-9272-4b3d-bc67-bea4dbe99a56
@vlplot(
	heigh = 500,
	width = 300,
    :bar,
...
# ╔═╡ b369a41d-5e2f-4de9-8b75-508642e9b30c
dates = Dates.Date.(df.event_date, Dates.DateFormat("d U y"))

# ╔═╡ 596c9fba-c26b-44d2-8a6f-d1f2e34812ff
length(dates)

# ╔═╡ 4aadefa2-1cd3-4f75-90b3-0a8358d7375a
months = []

# ╔═╡ b67f0d81-b5cd-456b-8f78-8d72ee750714
for date in dates
     push!(months, Int(Dates.month(date)))
end

# ╔═╡ afb96c60-e443-402c-b47a-1ea7d7d49908
length(months)

# ╔═╡ 05fb4880-8cba-4f39-aec9-7cec3190beeb
length(df.year)

# ╔═╡ 5048c7a1-5f17-4cc9-ac40-59c9ae02c100
df[!,"month"] = months

# ╔═╡ 74d64d83-1c09-4acc-834a-2703bf28d6d9
df

# ╔═╡ 6123f0d1-70f0-441b-905b-a3ce34c267fe
#podziały na lata
# rok 2016

# ╔═╡ 93cd0e68-e822-439b-94d7-1130c78fba2a
...
# ╔═╡ 9bb28e45-641b-40b0-a0d6-3c4733e867af
@vlplot(
	heigh = 500,
	width = 300,
    :bar,
...
# ╔═╡ 523cb8ce-6e01-47a5-b9d2-bf62d825ba0d
#rok 2017

# ╔═╡ 45a06987-98e2-4fa5-bc10-9b85eac8a4d4
...
# ╔═╡ 8268681b-4ff3-4642-9157-52d96970a33d
@vlplot(
	heigh = 500,
	width = 300,
    :bar,
   ...
   title = "Badanie występowania protestów w roku 2017"
    
)

# ╔═╡ 470f290f-4737-4f5d-814d-6e42884e12f2
#rok 2018

# ╔═╡ 8e5aa65d-2e3e-4607-90bd-bd8fa19e605d
...
# ╔═╡ e76470af-f157-4d77-865f-6c6a15a8b860
@vlplot(
	heigh = 500,
	width = 300,
    :bar,
   ...
   title = "Badanie występowania protestów w roku 2018"
    
)

# ╔═╡ 1314a1cf-c9aa-4d98-b64e-2fe32700943e
#rok 2019

# ╔═╡ c0b8b2dd-85c7-4ba8-a366-7bdf876d12bb
...
# ╔═╡ 382c012b-e789-4501-a290-e95d74dbe0e5
@vlplot(
	heigh = 500,
	width = 300,
    :bar,
   ...
   title = "Badanie występowania protestów w roku 2019"
    
)

# ╔═╡ 2207869d-55cd-431e-a9fd-9fbbc8ed8dfb
#rok 2020

# ╔═╡ 7505bd3d-e80d-487d-a660-de6e1f85c77b
...
# ╔═╡ eb5af6c5-b872-4be8-9d70-67b264639c0a
@vlplot(
	heigh = 500,
	width = 300,
    :bar,
   ...
   title = "Badanie występowania protestów w roku 2020"
    
)

# ╔═╡ c2e80acd-6d6a-4657-97e0-f6e8be38be86
# rok 2021

# ╔═╡ 29188239-8bfa-4a1b-b40b-289ca1a2e650
...
# ╔═╡ 11abce41-bf51-4baa-9373-3b03218754a2
@vlplot(
	heigh = 500,
	width = 300,
    :bar,
   ...
   title = "Badanie występowania protestów w roku 2021"
    
)

# ╔═╡ 2f993708-8827-4da7-9fed-c1a07c357821
#rok 2022

# ╔═╡ 534d9053-6613-45f7-bb19-b9240c356094
...
# ╔═╡ f61f788f-4330-4662-8d26-66bd42bdb3d8
@vlplot(
	heigh = 500,
	width = 300,
    :bar,
   ...
   title = "Badanie występowania protestów w roku 2022"
    
)

# ╔═╡ 22772310-d083-4284-8eb0-3b025583beed
#postaram się zrobić suwaki

# ╔═╡ 499774cc-1844-48a8-a133-f51bfac7bab5
function df_(data,year)
	@from i in data begin
		@where i.year == year
	    @select {i.event_date, i.month, i.event_type, i.sub_event_type}
	    @collect DataFrame
	end
end

# ╔═╡ 9a96c603-6043-46b4-bdd9-653724d8a32b
@bind value Slider(2016:2022)

# ╔═╡ 5733bc4b-5363-4b37-ba27-e732420039a1
@vlplot(
	heigh = 500,
	width = 300,
    :bar,
   ...
   title = "Badanie występowania protestów w roku $(value)"
...
git-tree-sha1 = "f5644eedb652c78c057e7397053a1b0fd1b0a401"
