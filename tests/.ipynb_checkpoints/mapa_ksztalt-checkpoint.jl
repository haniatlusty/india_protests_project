...
# ╔═╡ d4ee5d30-c64f-11ec-1c51-d3e8d1a3ec28
using JSON, VegaLite, CSV, DataFrames, CSV, HTTP

# ╔═╡ 6982cac9-24e3-456c-a216-60d2e46c0d6f
file = open("C:\\Users\\kkarb\\OneDrive\\Pulpit\\mapsindia1.json", "r")

# ╔═╡ 06367553-8254-44d6-a00c-a2f0b0c0f962
json = JSON.parse(file)

# ╔═╡ aaf640f7-4a1a-437e-bb2c-4c61de6e8328
maps = JSON.json(json)

# ╔═╡ f0171608-0c22-4418-94f9-2e2d8769221c
df = CSV.read("C:\\Users\\kkarb\\OneDrive\\Pulpit\\projektpm\\data\\2016-2022.csv", DataFrame, select=["location", "event_type", "sub_event_type", "latitude", "longitude"])

# ╔═╡ c2186ada-04ac-4f72-aff4-ce135032dab9
@vlplot(
    width=900, 
    height=700) +
